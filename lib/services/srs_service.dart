...
class SrsService {
  ...
  static UserWordProgress calculateNextReview(
    ...
    final nextReview = currentDate.add(Duration(days: newInterval));
    ...
    } else if (newInterval <= 21 && newStatus == 3) {
  ...
  /// Preview the next interval in days for a given quality score
  static int previewNextIntervalDays(int quality, UserWordProgress currentProgress) {
    if (quality < 0) quality = 0;
    if (quality > 5) quality = 5;
