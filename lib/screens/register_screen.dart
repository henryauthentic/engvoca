                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Miễn phí. Không giới hạn. Mãi mãi.',
                                style: TextStyle(
                                  fontSize: 16,
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          const Text('Đăng ký để bắt đầu học', style: AppConstants.subtitleStyle),
          ...
          Row(
            ...
            children: [
              ...
              TextButton(
                onPressed: () => Navigator.of(context).pop(),
                child: const Text(AppStrings.login, style: TextStyle(fontWeight: FontWeight.bold)),
              ),
            ],
          ),
        ],
